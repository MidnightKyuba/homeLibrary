...
<body class="container-fluid">
	...
	<div class="row main">
		<div class="offset-xl-3 col-xl-6 offset-xl-3 offset-lg-3 col-lg-6 offset-lg-3 offset-md-3 col-md-6 offset-md-3 col-sm-12 col-12 mainlight">
			...
			?>
			<h4 class="text">
			Masz pytanie? Zauważyłeś błąd?<br>
			Chcesz zostać edytorem lub adminem?<br>
			Napisz!
			</h4>
			<form action="../skrypty/sendmessage.php" method="post" autocomplete="on">
				<label class="form-label text">Tytuł:</label>
				<input type="text" name="Title" class="form-control">
				<label class="form-label text">Treść:</label>
