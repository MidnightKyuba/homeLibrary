...
<body class="container-fluid">
	...
	<div class="row main">
		<div class="offset-xl-1 col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="booksbase.php">
			<img class="img-fluid" src="../grafika/library1.png">
			<br>
			Baza książek
			</a>
		</div>
		<div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="mybooks.php">
			<img class="img-fluid" src="../grafika/mybooks.png">
			<br>
			Moje książki
			</a>
		</div>
		...
		<div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="contact.php">
			<img class="img-fluid" src="../grafika/contact1.png">
			<br>
			Kontakt
			</a>
		</div>
		<?php else :?>
		<div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="messages.php">
			<img class="img-fluid" src="../grafika/contact1.png">
			<br>
			Wiadomości
			</a>
		...
		<?php endif; ?>
		<div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="profile.php">
			<img class="img-fluid" src="../grafika/profile1.png">
			<br>
			Profil
			</a>
		</div>
		<div class="col-xl-2 col-lg-3 col-md-4 col-sm-12 col-12 text-center mainlight">
			<a class="text" href="../skrypty/logout.php">
			<img class="img-fluid" src="../grafika/logout1.png">
			<br>
			Wyloguj
			</a>
		</div>
