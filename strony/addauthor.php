...
<body class="container-fluid">
	...
	<div class="row main">
		<div class="offset-xl-3 col-xl-6 offset-xl-3 offset-lg-3 col-lg-6 offset-lg-3 offset-md-3 col-md-6 offset-md-3 col-sm-12 col-12 mainlight">
			<form action="../skrypty/addauthor.php" method="post" autocomplete="on">
				...
				<input class="form-control" type="text" minlenght="1" required name="Surname">
				<br>
				<label class="form-label text">Data urodzenia:</label>
				<input class="form-control" type="date" name="Birth">
				<br>
				<label class="form-label text">Czy autor nie żyje?</label>
				<br>
				<input type="radio" id="dy" name="ifDeath" value="true" onclick="enableElement('Death');">
				<label class="form-label text" for="dy">Yes</label>
				<br>
				<input type="radio" id="dn" name="ifDeath" value="false" onclick="disableElement('Death');" checked>
				<label class="form-label text" for="dn">No</label>
				<br>
				<label class="form-label text">Data śmierci:</label>
				<input class="form-control" id="Death" type="date" name="Death" disabled>
				<br>
				<label class="form-label text">Życiorys:</label>
				<textarea class="form-control" rows="10" name="Life"></textarea>
				<br>
	...
	<script src="../skrypty/DElement.js"></script>
	<script src="../skrypty/EElement.js"></script>
</body>
</html>